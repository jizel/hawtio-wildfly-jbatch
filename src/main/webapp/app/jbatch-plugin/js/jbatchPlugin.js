...
var JBatch = (function (JBatch) {
     ...
     */
    JBatch.pluginName = 'jbatch-plugin';
     ...
     * run function
     */
    JBatch.module = angular.module('jbatch-plugin', ['hawtioCore'])
...
//                    $httpProvider.defaults.withCredentials = true;
                 ...
                 */
                $routeProvider.
                        when('/jbatch-plugin/jobs', {
                            templateUrl: JBatch.templatePath + 'simple.html'
                        })
                        .when('/jbatch-plugin/startJob', {
    ...
    JBatch.module.run(function (workspace, viewRegistry, layoutFull, $rootScope, $http) {
        ...
        viewRegistry["jbatch-plugin"] = layoutFull;
...
//        $http.defaults.withCredentials = true;
        ...
        workspace.topLevelTabs.push({
            ...
            href: function () {
                return "#/jbatch-plugin/jobs";
            },
            isActive: function (workspace) {
                return workspace.isLinkActive("jbatch-plugin/jobs");
            }
...
//        Methods consuming the REST resources
        $http({
            ...
            url: "http://localhost:8080/jbatch-plugin/rest/jobs/names"
//            headers:{
...
//                  });
        ...
        $scope.getBatchDeployments = function () {
            $http.get("http://localhost:8080/jbatch-plugin/rest/cli/batchDepl;jsessionid=" + document.cookie.split(";")[0].split("=")[1], 
            {
...
hawtioPluginLoader.addUrl("/hawtio/" + JBatch.pluginName);
